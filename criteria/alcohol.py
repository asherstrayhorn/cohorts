# This code has been modified to return a string output for
# each file loaded into the algorithm.
import nltk
import re
...
def alc(raw_text):
    ...
    sentences = nltk.sent_tokenize(sections[0])
    ...
    for s in sentences:
        ...
        if drink_score >= 1 and abuse_score >= 1:
            hotspot_lines.add(i + line_count)
